...
def test_save_history_invalid_filename(tmp_path):
    ...
    try:
        ...
        assert False, "Expected an exception due to invalid filename"
    except Exception as e:
        assert isinstance(e, (OSError, ValueError)), f"Expected OSError or ValueError, got {type(e)}"

def test_save_history_large_history(tmp_path):
    history = [{"i": i, "cpu_mj": i * 1.0, "gpu_mj": i * 0.5, "ane_mj": i * 0.2, "dram_mj": i * 0.1} for i in range(1000)]
